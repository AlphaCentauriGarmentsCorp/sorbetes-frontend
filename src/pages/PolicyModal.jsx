...
const POLICY_TABS = [
  {
    ...
    sections: [
      ...
      { heading: '1.7 SHIPPING & RISK', body: 'Risk of loss transfers to the courier upon handover for delivery.' },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: '2.4 DATA PROTECTION', body: 'lorem ipsum' },
      {
      ...
      { heading: '2.6 POLICY UPDATES', body: 'This Privacy Policy may be updated without prior notice.' },
    ],
  },
  {
    id: 'payment',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          'Orders must be claimed within 30 days after production. No refunds will be issued for unclaimed orders. Unclaimed orders may be:',
...
function PolicyModal({ onClose }) {
  ...
  const modal = (
    <div className="auth-policy-overlay" role="presentation">
      <article className="auth-policy-modal" role="dialog" aria-modal="true" aria-labelledby="footer-policy-title">
        <div className="auth-policy-header">
          <div className="auth-policy-brand">
            <img src={logoImg} alt="" />
            <span>SORBETES</span>
          </div>
          <button type="button" className="auth-policy-close" aria-label="Close policies" onClick={onClose}>
            ×
          </button>
        </div>
        ...
        <div className="auth-policy-disclaimer">
          ...
          business losses, indirect damages or expectations brought by the products. The seller is not responsible for
          any products that do not meet the business partner&apos;s expectations unless said products contain defects that
          are proven to be entirely the fault of our manufacturing process.
        </div>
        ...
        <p className="auth-policy-agreement">
          ...
          collect, use, and share your information in accordance with our <button type="button">Privacy Policy</button>.
        </p>

        <div className="auth-policy-actions">
          <button type="button" className="auth-policy-cancel" onClick={onClose}>
            Cancel
          </button>
        </div>
      </article>
